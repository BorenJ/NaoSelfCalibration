...
function NaoVisualize(JointPos, R, FootCorner, EndeffLoc, ConvexC,  Com, MassLoc, LinkRadians, CollisionPoint, CollisionFlag, CoordOpt, ConvOpt, COMOpt, StableOpt, CollisionOpt)
...
if COMOpt == 1
    ...
    plot3(Com(1),Com(2),Com(3),'rs','MarkerFaceColor','r','MarkerSize',5);hold on% Plot 3-D COM
    plot3(Com(1),Com(2),0.5,'mo','MarkerFaceColor','m','MarkerSize',8,'MarkerEdgeColor','k');hold on   % Plot 2-D COM projection
else
    plot3(Com(1),Com(2),0.5,'mo','MarkerFaceColor','m','MarkerSize',8,'MarkerEdgeColor','k');hold on   % Plot 2-D COM projection
end
