function [COM_Lim, COM_Loc, Center, COM_Lim_All] = COM_Divider_2SegV2(FootCorner0, d)
...
COM_Lim(1,:,2) = [min(FCL(:,2)), 0];
COM_Lim(2,:,2) = [min(FCL(:,2)), 0];
COM_Lim(3,:,2) = [0, max(FCL(:,2))];
COM_Lim(4,:,2) = [0, max(FCL(:,2))];
